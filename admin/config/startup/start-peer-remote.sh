...
export CORE_VM_DOCKER_HOSTCONFIG_NETWORKMODE=sharding_hyperledger_loyalty_network
export FABRIC_LOGGING_SPEC=INFO
export CORE_PEER_TLS_ENABLED=true
export CORE_PEER_PROFILE_ENABLED=false
export CORE_PEER_LOCALMSPID=${ORG^}MSP
LOG_FOLDER=/var/log/loyalty
PEER_FOLDER=/var/loyalty
...
export CORE_METRICS_PROVIDER=${METRICS_PROVIDER}
