...
export CORE_PEER_ADDRESS_2=$PEER2.$ORG2.$CONSORTIUM:$PORT2
export CORE_PEER_ADDRESS_3=$PEER3.$ORG3.$CONSORTIUM:$PORT3
...
export CORE_PEER_TLS_ROOTCERT_FILE_3=${PWD}/../${ORG3}/peers/crypto-config/peerOrganizations/${ORG3}.$CONSORTIUM/peers/$PEER3.${ORG3}.$CONSORTIUM/tls/ca.crt
...
--peerAddresses $CORE_PEER_ADDRESS_3 \
--tlsRootCertFiles $CORE_PEER_TLS_ROOTCERT_FILE_3 \
-c ${ARGS} \
--waitForEvent \
